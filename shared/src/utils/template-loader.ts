export function renderTemplate(templateName: string, data: any): string {
  // Simple template rendering for report-email
...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>Hello,</p>
      <p>Your scheduled <strong>{{reportTypeDisplayLower}}</strong> report has been generated and is attached to this email.</p>
